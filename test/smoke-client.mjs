...
if (code.includes('settings.cookieCredentialHint') || code.includes('settings.directCredentialHint')) throw new Error('credential inputs should rely on concise placeholders')
...
if (!code.includes('直接填写凭证') || !code.includes('settings.directCredentialConfigured')) throw new Error('write-only direct credential UI missing')
...
if (!code.includes('dshqb_provider_editor_footer') || !code.includes('settings.btnSave')) throw new Error('provider editor must expose local save actions')
